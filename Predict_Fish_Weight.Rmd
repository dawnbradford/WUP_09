...
The p-value is too large to say that there is a difference between utilizing the best model which utilizes variables and the best model that utilizes two. 
...
The p-value is too large to say that there is a difference between the best model which utilizes four variables and the best model that uses two variables.
